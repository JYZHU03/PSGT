...
parser.add_argument('--epochs', type=int, default=600, help='maximum number of epochs') #60
...
if __name__ == '__main__':
	...
	for epoch in tqdm(range(args.epochs)):
		...
		print(f'Test set results: acc重要: {acc:.4f}, f1_macro: {f1_macro:.4f}, f1_micro: {f1_micro:.4f}, '
